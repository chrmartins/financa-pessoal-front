  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-violet-600 text-slate-50 hover:bg-violet-600 hover:text-slate-50 focus:bg-violet-600 focus:text-slate-50 dark:bg-violet-500 dark:text-slate-900 dark:hover:bg-violet-500 dark:hover:text-slate-900 dark:focus:bg-violet-500 dark:focus:text-slate-900",
        day_today:
